If the TeamForge server has SELinux `enabled`, run it in `permissive` mode temporarily while installing or upgrading TeamForge.
	<button type="button" class="btn btn-primary btn-xs" data-toggle="collapse" href="#setUpSelinuxThird" aria-expanded="false" aria-controls="setUpSelinuxThird" markdown="1">Show/Hide</button>
	<div class="collapse" id="setUpSelinuxThird" markdown="1">
	<div class="well well-lg" markdown="1">
	<h3 markdown="1">Switch SELinux to `permissive` Mode</h3>
