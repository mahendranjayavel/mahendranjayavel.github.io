If the TeamForge server has SELinux `enabled`, run it in `permissive` mode temporarily while installing or upgrading TeamForge.
	<button type="button" class="btn btn-primary btn-xs" data-toggle="collapse" href="#setUpSelinux" aria-expanded="false" aria-controls="setUpSelinux" markdown="1">Show/Hide</button>
	<div class="collapse" id="setUpSelinux" markdown="1">
